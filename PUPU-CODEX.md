...
- 主人自定义角色提示词是对话语气、态度和措辞的最高角色优先级，仅低于必要安全边界和档案身份事实；不得在固定系统提示词中硬编码“爱答不理”“不处处答应”等相反人格。
- 主人明确发起的普通互动使用档案中的独立“互动接受倾向”（默认 90%）调节真实状态门槛，不得再由性格、关系、偏好和随机数构成隐藏拒绝概率；正常状态直接接受，饱腹、睡眠、笼中、旅行、动作不可中断等真实原因仍由统一仲裁阻止。
